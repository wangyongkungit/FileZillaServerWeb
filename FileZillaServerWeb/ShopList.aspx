...
<body>
    <form id="form1" runat="server">
        <div style="width: 1200px; margin: 0 auto; text-align: center;">
                ...
                <a href="javascript:void()" onclick="location.href='/ShopList.aspx'">刷新</a>
            </div>
            <h1>店铺列表</h1>
            <asp:GridView ID="gvShop" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" CssClass="tbl" RowStyle-Height="28" OnRowCommand="gvShop_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href='ShopAddEdit.aspx?shopid=<%# Eval("shopid") %>' target="_blank" class="mya" style="display:inline-block;">编辑</a>
