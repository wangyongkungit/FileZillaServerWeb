    ...
    <div id="container" class="container">
        <div id="header" class="header">
            ...
            <div class="formSearch">
                ...
                <asp:TextBox ID="txtOrderAmountMin" runat="server" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" MaxLength="8" Width="45" placeholder="&yen;" />&nbsp;至
                    <asp:TextBox ID="txtOrderAmountMax" runat="server" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" MaxLength="8" Width="45" placeholder="&yen;" />
            </div>
            <div class="formSearch">
                <div class="formSearchLeft">
                    <label>完成人：</label>
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            ...
                            <span class="edit">
                                <a href="/Pages/Task/SerialNumberGenerating.aspx?projectID=<%# Eval("ID") %>" target="_blank" title="任务编辑">
                            ...
                            <span class="proportion">
                                ...
                                <asp:HyperLink ID="hlTaskProportion" runat="server" NavigateUrl='<%# "/Pages/Admin/TaskProportionManagement.aspx?projectID=" + Eval("ID") %>' Target="_blank"
                            ...
                            <div class="test" id='<%# "cls"+ Container.ItemIndex %>' style="display: none;">
                                <span class="item"><span class="itemtitle">工程名称：</span><%# Eval("projectname") %></span><span class="item"><span class="itemtitle">下单时间：</span><%# string.Format("{0:yyyy-MM-dd HH:mm:ss}", Eval("orderdate")) %></span><span class="item"><span class="itemtitle">金额：</span>&yen;<%# Eval("orderamount") %></span><span class="item"><span class="itemtitle">省份：</span><%# Eval("provincename") %></span><br /><span class="item"><span class="itemtitle">层高：</span><%# Eval("floors") %></span><span class="item"><span class="itemtitle">建筑面积：</span><%# Eval("constructionarea") %></span><span class="item"><span class="itemtitle">结构类型：</span><%# Eval("structureform") %></span><span class="item"><span class="itemtitle">建筑类型：</span><%# Eval("buildingtype") %></span><span class="item"><span class="itemtitle">计价模式：</span><%# Eval("VALUATEMODE") %></span><span class="item"><span class="itemtitle">计价软件：</span><%# Eval("VALUATESOFTWARE") %></span><br /><span class="item"><span class="itemtitle">手机：</span><%# Eval("mobilephone") %></span><span class="item"><span class="itemtitle">邮箱：</span><%# Eval("email") %></span><span class="item"><span class="itemtitle">QQ：</span><%# Eval("qq") %></span><span class="item"><span class="itemtitle">支付方式：</span><%# Eval("paymentmethod") %></span><br /><span class="item"><span class="itemtitle">其他要求：</span><%# Eval("extrarequirement") %></span><span class="item"><span class="itemtitle">备注：</span><%# Eval("remarks") %></span></div>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
