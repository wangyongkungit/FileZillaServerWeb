            ...
            try
            {
                ...
                else
                {
                    ...
                    if (success)
                    {
                        ...
                        //ExecuteScript("alert('生成成功！');window.location.href='/Pages/Task/SerialNumberGenerating.aspx?projectID=" + project.ID + "';");
                        return;
                    }
                    else
                    {
        ...
        protected void btnAssign_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (psBll.Add(ps))
                {
                    ...
                    ClientScript.RegisterStartupScript(this.GetType(), Guid.NewGuid().ToString(), "alert('分配成功！');window.location.href='/Pages/Task/SerialNumberGenerating.aspx?projectID=" + projectID + "';", true);
                    return;
                }

                ClientScript.RegisterStartupScript(this.GetType(), Guid.NewGuid().ToString(), "alert('新增完成人失败！');window.location.href='/Pages/Task/SerialNumberGenerating.aspx?projectID=" + projectID + "';", true);
                return;
            }
            catch (Exception ex)
            {
