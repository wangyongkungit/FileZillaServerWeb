    ...
    <form id="form1" runat="server">
        <div style="width: 1200px; margin: 0 auto; text-align: center;">
            <div style="width:200px; height: 30px; float:right; position:absolute; right:50px; top: 50px;">
                <a href="javascript:void()" onclick="location.href='/Pages/CustomerService/CustomerServiceTrends.aspx'">刷新</a>
            </div>
            <h1 id="title">我的动态</h1>
            <asp:GridView ID="gvTrend" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" CssClass="tbl" RowStyle-Height="28" OnRowCommand="gvTrend_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href='/Pages/Task/SerialNumberGenerating.aspx?projectid=<%# Eval("projectid") %>' target="_blank" class="mya" style="display:inline;">查看任务</a>
