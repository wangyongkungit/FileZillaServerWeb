<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Outgoings.aspx.cs" Inherits="FileZillaServerWeb.Outgoings" %>
            ...
            <div style="width: 1000px; margin: 0 auto;">
                <div style="width: 100%; height: 40px;">
                    <div style="width: 50%; height: 40px; float: left;">
                        <label>任务编号：</label>
                        <asp:TextBox ID="txtTaskNoSearch" runat="server" Width="200"></asp:TextBox>
                        <asp:Button ID="btnSearchByTaskNo" runat="server" Text="查询" OnClick="btnSearchByTaskNo_Click" ToolTip="点击根据任务编号查询记录" CssClass="mya" />
                    </div>
                    <div style="width: 50%; height: 40px; float: left;">
                        <label>员工：</label>
                        <asp:DropDownList ID="ddlEmployeeName" runat="server" />
                        <asp:Button ID="btnSearchByEmpNo" runat="server" Text="查询" OnClick="btnSearchByEmpNo_Click" CssClass="mya" ToolTip="点击根据员工编号查询记录" />
                    </div>
                </div>
